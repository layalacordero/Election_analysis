...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (votes_county > largest_county_count) and (votes_county_percentage > largest_county_percentage):
    ...
    largetst_turnout_summary = (
        f"\n"
        f"-------------------------\n"
        f"Largest County Turnout: {largest_turnout}\n"
        f"-------------------------\n")
    print(largetst_turnout_summary)

    # 8: Save the county with the largest turnout to a text file.
    txt_file.write(largetst_turnout_summary)
